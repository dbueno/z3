...
extern "C" {
    ...
    Z3_ast mk_app_array_core(z3__in Z3_context c, z3__in Z3_sort domain, z3__in Z3_ast v) {
        RESET_ERROR_CODE();   
        ast_manager & m = mk_c(c)->m();
        expr * _v        = to_expr(v);
        sort * _range = m.get_sort(_v);
    ...
    Z3_ast Z3_mk_set_member(z3__in Z3_context c, z3__in Z3_ast elem, z3__in Z3_ast set) {
        return Z3_mk_select(c, set, elem);
    }

    Z3_ast Z3_mk_set_add(z3__in Z3_context c, z3__in Z3_ast set, z3__in Z3_ast elem) {
        return Z3_mk_store(c, set, elem, Z3_mk_true(c));
    }

    Z3_ast Z3_mk_set_del(z3__in Z3_context c, z3__in Z3_ast set, z3__in Z3_ast elem) {
