...
Z3_ast Z3_API NAME(Z3_context c, unsigned i, Z3_ast n) {                \
    ...
    */
    Z3_ast Z3_API Z3_mk_bvmsb(z3__in Z3_context c, z3__in Z3_sort s) {
        Z3_TRY;
        RESET_ERROR_CODE();
    ...
    Z3_ast Z3_mk_bvsmin(z3__in Z3_context c, z3__in Z3_sort s) {
        return Z3_mk_bvmsb(c, s);
    }

    Z3_ast Z3_mk_bvsmax(z3__in Z3_context c, z3__in Z3_sort s) {
        return Z3_mk_bvnot(c, Z3_mk_bvmsb(c, s));
    }

    Z3_ast Z3_mk_bvumax(z3__in Z3_context c, z3__in Z3_sort s) {
    ...
    Z3_ast Z3_API Z3_mk_bvmul_no_overflow(z3__in Z3_context c, z3__in Z3_ast n1, z3__in Z3_ast n2, Z3_bool is_signed) {
    ...
    // only for signed machine integers
    Z3_ast Z3_API Z3_mk_bvmul_no_underflow(z3__in Z3_context c, z3__in Z3_ast n1, z3__in Z3_ast n2) {
        LOG_Z3_mk_bvmul_no_underflow(c, n1, n2);
        MK_BINARY_BODY(Z3_mk_bvmul_no_underflow, mk_c(c)->get_bv_fid(), OP_BSMUL_NO_UDFL, SKIP);
    }

    // only for signed machine integers
    Z3_ast Z3_API Z3_mk_bvneg_no_overflow(z3__in Z3_context c, z3__in Z3_ast t) {
        Z3_TRY;
        RESET_ERROR_CODE();
