...
extern "C" {
    ...
    */
    Z3_ast Z3_API Z3_mk_interpolant(z3__in Z3_context c, z3__in Z3_ast a);
    ...
    */
    ...
    Z3_context Z3_API Z3_mk_interpolation_context(z3__in Z3_config cfg);
    ...
    Z3_lbool Z3_API Z3_compute_interpolant(z3__in Z3_context c, 
                                           z3__in Z3_ast pat, 
                                           z3__in Z3_params p, 
                                           z3__out Z3_ast_vector *interp, 
    ...
    Z3_string Z3_API Z3_interpolation_profile(z3__in Z3_context ctx);
    ...
    int Z3_API Z3_read_interpolation_problem(z3__in Z3_context ctx,
                                             z3__out unsigned *num,
                                             z3__out Z3_ast *cnsts[],
                                             z3__out unsigned *parents[],
                                             z3__in Z3_string filename,
                                             __out_opt Z3_string_ptr error,
                                             z3__out unsigned *num_theory,
                                             z3__out Z3_ast *theory[]);
    ...
    int Z3_API Z3_check_interpolant(z3__in Z3_context ctx,
                                    z3__in unsigned num,
    ...
    void Z3_API  Z3_write_interpolation_problem(z3__in Z3_context ctx,
                                                z3__in unsigned num,
                                                __in_ecount(num) Z3_ast cnsts[],
                                                __in_ecount(num) unsigned parents[],
                                                z3__in Z3_string filename,
