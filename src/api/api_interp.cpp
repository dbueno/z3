...
extern "C" {
    ...
    Z3_ast_vector Z3_API Z3_get_interpolant(z3__in Z3_context c, z3__in Z3_ast pf, z3__in Z3_ast pat, z3__in Z3_params p){
        Z3_TRY;
    ...
    Z3_lbool Z3_API Z3_compute_interpolant(z3__in Z3_context c, z3__in Z3_ast pat, z3__in Z3_params p, z3__out Z3_ast_vector *out_interp, z3__out Z3_model *model){
        Z3_TRY;
...
Z3_lbool Z3_API Z3_interpolate(z3__in Z3_context ctx,
                               z3__in unsigned num,
                               __in_ecount(num) Z3_ast *cnsts,
                               __in_ecount(num) unsigned *parents,
                               z3__in Z3_params options,
                               __out_ecount(num - 1) Z3_ast *interps,
                               z3__out Z3_model *model,
                               z3__out Z3_literals *labels,
                               z3__in unsigned incremental,
                               z3__in unsigned num_theory,
